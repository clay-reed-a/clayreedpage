...
function recreateViewPortUnits() {
...
window.addEventListener('resize', recreateViewPortUnits);
window.addEventListener('orientationchange', recreateViewPortUnits);
window.addEventListener('scroll', recreateViewPortUnits, true);
